...
// Tu código acá:
  document.querySelector("#createdBy").innerHTML += " <strong>Argiro</strong>";
...
// Tu código acá:
let eventClick = document.getElementById("addButton");
eventClick.addEventListener("click", addToDo);
